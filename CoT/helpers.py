...
from CoT.features import FeatureListNet, FeatureDictNet, FeatureHookNet
from CoT.layers import Conv2dSame
...
def build_model_with_cfg(
    ...
    # num_classes_pretrained = 0 if features else getattr(model, 'num_classes', kwargs.get('num_classes', 3))
